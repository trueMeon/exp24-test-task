...
from src.message_handler import SERVICE_WHATSAPP, MessageHandler, MessageHandlerRequest, MessageServiceFactory
...
if __name__ == '__main__':
    ...
    request = MessageHandlerRequest()\
        ...
        .append_messages(['Test0', 'Test1', 'Test2!', 'Test*1', 'Test*2'])
